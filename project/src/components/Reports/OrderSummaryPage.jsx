...
const OrderSummaryPage = () => {
  ...
  // Add state to track if error toast has been shown
  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      // Only show "No orders found" message after initial load
      if (initialLoadDone && ordersData.length === 0) {
      ...
      // Only show error toast once during initial load
      if (!initialLoadDone) {
  ...
  }, [fromDate, toDate, initialLoadDone]);
